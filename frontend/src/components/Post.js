...
function Post(props) {
    ...
    async function checkIsLiked(_id) {
        ...
        // console.log(token)
        axios.get(`https://main--college-l-web.netlify.app/college/${collegeId}/posts/${_id}/isLiked`, {
    ...
    function changeUpdateClick() {
        ...
        if (tempCaption !== newCaption) {
            ...
            axios.put(`https://main--college-l-web.netlify.app/college/${collegeId}/posts/${_id}`, {
                "caption": tempCaption
            }, { headers: headers })
